...
import { Plus, Stethoscope, LogOut, Menu, X, Activity } from 'lucide-react';
import { useAuthStore } from '../../store/authStore';
import { authApi } from '../../api/auth';

const navItems = [
  { to: '/doctor', label: 'Consultation Station', icon: Activity },
];
...
export function DoctorNav() {
  ...
  const displayName = userName || 'Dr. Medical Staff';
      ...
      <div className="container mx-auto px-6 max-w-6xl flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-semibold text-[#00685b] tracking-wider uppercase flex items-center gap-1">
              <Stethoscope size={11} />
