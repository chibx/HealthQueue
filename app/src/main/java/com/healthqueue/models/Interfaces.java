...
public class Interfaces {
    ...
    // CreatePatient createAndReturn(CreatePatientParams params) throws
    // DatabaseException;

    // void createSession(CreatePatientSessionParams params) throws
    // DatabaseException;
    ...
    // GetDoctorLogin getDoctorLogin(String organizationName, String email) throws
    // DatabaseException;

    // void createSession(CreateDoctorSessionParams params) throws
    // DatabaseException;

    // long getSessionDoctorId(String token) throws DatabaseException;

    // void deleteSession(long id, String token) throws DatabaseException;

    // void delete(UUID orgId, long branchId, long doctorId) throws
    // DatabaseException;

    // void updateBranch(UUID orgId, long newBranchId, long oldBranchId, long
    // doctorId) throws DatabaseException;

    // boolean checkDoctorAvailability(long doctorId, ZonedDateTime startTime,
    ...
    // // void updateStatus(UpdateAppointmentParams params) throws
    // DatabaseException;
    ...
    // public interface Appointments {
    // Appointment createAndReturn(CreateAppointmentParams params) throws
    // DatabaseException;

    // void updateStatus(Types.UpdateAppointmentParams params) throws
    // Types.DatabaseException;

    // void reassignDoctor(Types.ReassignDoctorParams params) throws
    // Types.DatabaseException;

    // Appointment getAppointmentDetails(long appointmentId) throws
    // Types.DatabaseException;
    // }
