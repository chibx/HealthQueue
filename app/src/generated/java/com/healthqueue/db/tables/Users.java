...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.latitude</code>.
     */
    public final TableField<UsersRecord, BigDecimal> LATITUDE = createField(DSL.name("latitude"), SQLDataType.NUMERIC(10, 8), this, "");

    /**
     * The column <code>public.users.longitude</code>.
     */
    public final TableField<UsersRecord, BigDecimal> LONGITUDE = createField(DSL.name("longitude"), SQLDataType.NUMERIC(11, 8), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USERS_LOCATION);
    }
    ...
    public AppointmentsPath appointments() {
        if (_appointments == null)
            _appointments = new AppointmentsPath(this, null, Keys.APPOINTMENTS__APPOINTMENTS_USER_ID_FKEY.getInverseKey());
    ...
    public ClinicVisitsPath clinicVisits() {
        if (_clinicVisits == null)
            _clinicVisits = new ClinicVisitsPath(this, null, Keys.CLINIC_VISITS__CLINIC_VISITS_USER_ID_FKEY.getInverseKey());
