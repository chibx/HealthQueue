...
public class Organizations extends TableImpl<OrganizationsRecord> {
     ...
     */
    public final TableField<OrganizationsRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");
    ...
    /**
     * The column <code>public.organizations.email</code>.
     */
    public final TableField<OrganizationsRecord, String> EMAIL = createField(DSL.name("email"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.organizations.created_at</code>.
     */
    public final TableField<OrganizationsRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<UniqueKey<OrganizationsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ORGANIZATIONS_EMAIL_KEY);
    }

    private transient BranchesPath _branches;

    /**
     * Get the implicit to-many join path to the <code>public.branches</code>
     * table
     */
    public BranchesPath branches() {
        if (_branches == null)
            _branches = new BranchesPath(this, null, Keys.BRANCHES__BRANCHES_ORGANIZATION_ID_FKEY.getInverseKey());
